...
const EmailTemplate = ({codePass,userName }) => {
  ...
  return React.createElement('div', { style: styles.emailContainer },
    React.createElement('div', { style: styles.emailContent },
      ...
      React.createElement('div', { style: styles.resetImg },
        React.createElement('img', { src: 'https://2wave.io/AGEmailImages/reset.png', alt: "Reset Image", style: styles.resetImgSize }) // added alt text for better accessibility
      ),
      React.createElement('h2', { style: styles.emailTitle }, "Password Recovery"),
      React.createElement('p', { style: styles.user }, "Hello " + userName + ","),
      React.createElement('p', { style: styles.text }, "We received a request to reset the password for your Attract Game account. Please use the recovery link and code below:"),
      ...
      React.createElement('p', { style: styles.text }, "If you didn’t request a password reset, you can ignore this email."),
